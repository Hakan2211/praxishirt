        ...
        <div className="col-start-2 max-w-[1000px]">
          ...
          <div className="flex flex-col gap-4 mt-8">
            ...
            <p className="mt-14 mb-14 text-2xl text-stone-50 dark:text-gray-400">
              ...
              <p className="mt-8">
                Ich freue mich Sie auf meiner Praxiswebseite begrüßen zu dürfen.
              </p>
              <h2 className="mt-8 font-bold">Behandlungsansatz:</h2>
              <p className="mt-8">
                Seit mehreren Jahren arbeite ich im klinischen und im ambulanten
                Bereich mit Menschen, die in seelische und psychische Notlage
                sind und{' '}
              ...
              <p className="mt-8">
                ...
                unsere Zusammenarbeit sehr wichtig. Es ist mir wichtig, Sie als
                Mensch kennenzulernen.
              </p>
              <p className="mt-8">
                Ich möchte Ihnen einen sicheren Raum geben, in dem Sie sich mit
                Ihren unangenehmen und schwierigen Themen auseinandersetzen
                können. Alte Muster der Gewohnheiten zu verändern und
                verlorengegangene Funktionen wiederherzustellen. In diesem
                Prozess bekommen Sie von mir immer wieder Rückmeldungen, wie Sie
                sich selbst freundlich und sanft begegnen können.
              </p>
              <p className="mt-8">
                Auf diesem Weg sind die biographischen Erfahrungen und alte
                emotionale Verletzungen, die Ihr Verhalten auch heute stark
                prägen, zu verarbeiten. In meiner Therapie ist es wichtig, sich
                Selbst und eigenes Erleben zu verstehen, Ihr Leben nach Ihren
                eigenen Bedürfnissen zu fokussieren.
              </p>
              <h2 className="mt-8 font-bold">Verhaltenstherapie:</h2>
              <p className="mt-8">
                Verhaltenstherapie geht davon aus, dass jegliches Denken, Gefühl
                und Verhalten als Muster erlernt ist ( durch Familie,
              ...
              <p className="mt-8">
                Verhaltenstherapie setzt an den prädispornierenden, auslösenden
                und aufrechterhaltenden Problembedingungen an. Sie ist
                zielorientiert, handlungsorientiert und bemüht sich um
